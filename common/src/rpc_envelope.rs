...
#[derive(Serialize, Deserialize, Debug)]
pub enum CtrlMsg {
    Configure { device_id: u64, cfg: radio_config::RadioConfig },
    Subscribe { sink_addr: String, device_id: u64, mode: adapter_mode::AdapterMode },
    Unsubscribe { sink_addr: String },
    PollDevices,
    Heartbeat,
}
...
#[derive(Serialize, Deserialize, Debug)]
pub enum DataMsg {
    RawFrame { ts: u64, bytes: Vec<u8> , source_type: SourceType}, // raw bytestream, requires decoding adapter
